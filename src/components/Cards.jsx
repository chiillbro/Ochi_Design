const Cards = () => {
  return (
    <section
      data-scroll
      data-scroll-speed=".1"
      className=" w-full cardsContainer flex items-center justify-center p-10 gap-5 max-md:flex-col "
    >
      <div className="relative flex items-center justify-center h-[50vh] w-[50vw] bg-[#004D43] rounded-2xl max-md:w-full ">
        <h1 className="text-center text-[#CDEA68] ">
          <svg
            width="140"
            height="140"
            viewBox="0 0 72 30"
        ...
        <button className="absolute  left-8 bottom-8 border-2 border-[#CDEA68] rounded-3xl py-1 px-2.5">
          <span className="font-bold text-[#CDEA68] text-sm">©2019-2022</span>
        </button>
      </div>
      <div className="flex gap-5 max-md:w-full">
        <div className="h-[50vh] w-[25vw] relative flex items-center justify-center bg-[#E73C37] rounded-2xl max-md:w-[50vw]">
          <img
            src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg"
            alt=""
          />
          <button className="absolute  left-8 bottom-8 border-2 border-[#F1F1F1] rounded-3xl py-1 px-2.5 hover:bg-white hover:text-black ease-out duration-1000">
