const Footer = () => {
  return (
    <section
      data-scroll
      data-scroll-speed=".5"
      className=" relative w-full  flex justify-between px-12 py-20 max-md:flex-col"
    >
      <div>
        <h1 className="text-[5vw] leading-[.8] font-bold font-['Founders_Grotesk_X-Condensed'] max-w-10">
          EYE-OPENING
        </h1>
        <p className="absolute bottom-5 left-20 max-md:bottom-[40vh] max-md:left-[5vw]">
          <svg
            width="90"
            height="90"
            viewBox="0 0 72 30"
      ...
      <div className="w-1/2 text-[#a29f9f] text-xl">
        <h1 className="text-[5vw] text-white font-bold font-['Founders_Grotesk_X-Condensed'] ">
          PRESENTATIONS
        </h1>
        <div className="my-6">
          <p className="mb-8">S:</p>
        ...
        <div className="my-6">
          <p className="mb-8">E:</p>
          <a className="block" href="/">
            hello@ochi.design
          </a>
        </div>
        <div className=" text-sm flex items-end justify-between pt-10 text-slate-500 max-md:flex-col max-md:items-center max-md:pt-[30vh] max-md:gap-8">
